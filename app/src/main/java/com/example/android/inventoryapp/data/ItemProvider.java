...
public class ItemProvider extends ContentProvider {
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String supplier = values.getAsString(ItemContract.ItemEntry.COLUMN_PRODUCT_SUPPLIER);
        if (supplier == null) {
            throw new IllegalArgumentException("Item requires a supplier");
        }

        String category = values.getAsString(ItemContract.ItemEntry.COLUMN_PRODUCT_CATEGORY);
        if (category == null) {
